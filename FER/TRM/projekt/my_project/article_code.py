...
cs = math.sqrt(1.4*287*T)  # sound speed as function of temperature
Mach = v/cs  # Mach number
if Mach < 1
Cd = C0/math.sqrt(1-Mach**2)  # Prandtl-Glauert Rule
elif Mach == 1
Mach = 0.99999  # eliminate the singularity
Cd = C0/math.sqrt(1-Mach**2)
elif Mach > 1
Cd = C0/math.sqrt(Mach**2 - 1)
end
x = Cd
end
